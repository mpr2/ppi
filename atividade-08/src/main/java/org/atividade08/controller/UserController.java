...
public class UserController extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		super.init(config);
		System.out.println("UserController inicializado.");
	...
	public void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("Service chamado em UserController - Método HTTP: " + req.getMethod());
		super.service(req, resp); // encaminha para doGet, doPost, etc.
	}

	// ===== DESTROY =====
	@Override
	public void destroy() {
		System.out.println("UserController finalizado.");
	}
